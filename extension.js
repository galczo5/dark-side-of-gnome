...
const GETTEXT_DOMAIN = 'gnome-dark-side-indicator';
...
const Indicator = GObject.registerClass(
  class Indicator extends PanelMenu.Button {
      _init() {
          ...
          super._init(0.0, _('Dark side of Gnome'));
...
class Extension {
    ...
    enable() {
        Util.spawn(['/bin/bash', '-c', "node ~/.local/share/gnome-shell/extensions/dark-side@kamil-galek.pl/dark.js"])
